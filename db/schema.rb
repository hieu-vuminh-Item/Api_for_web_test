...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "accounts", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "username"
    t.string "password"
    t.integer "role_id"
    t.integer "status_id"
  ...
  add_foreign_key "accounts", "roles", name: "accounts_ibfk_1"
  add_foreign_key "accounts", "status", name: "accounts_ibfk_2"
end
